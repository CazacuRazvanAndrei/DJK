...
Navigate to the ~/fod/ch16/probes folder and build the Docker image with the following command:
Copy
$ docker image build -t fundamentalsofdocker/probes-demo:2.0 .
Use kubectl to deploy the sample pod that's defined in probes-demo.yaml:
Copy
